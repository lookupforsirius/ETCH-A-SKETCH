...
gridDiv.setAttribute("id", "gridDivision");
function drawGrid() {
...
function changeSquares() {
    ...
    if (squares !== null && Number(squares) >= 0) {
        document.getElementById("gridDivision").innerHTML = ""
        document.getElementById("gridDivision").style.gridTemplateColumns = "repeat(" + squares + ", 1fr)";
        document.getElementById("gridDivision").style.gridTemplateRows = "repeat(" + squares + ", 1fr)";
        drawGrid();
    }
    else {
